...
public:
  ...
  {
    ServiceGetEndEffectorVelocities = this->create_service<final_project_msgs::srv::GetEndEffectorVelocities>(
...
private:
  ...
  rclcpp::Service<final_project_msgs::srv::GetJointValues>::SharedPtr ServiceGetEndEffectorVelocities;
};
